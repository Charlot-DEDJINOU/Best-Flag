...
def main():
    ...
    parser.add_argument('-h', '--image_to_image', type=str, help='Input file path (image to hide)')
    parser.add_argument('-H', '--host_image', type=str, help='Input file path (host image)')
    parser.add_argument('-o', '--output', type=str, help='Output file path')
    
    args = parser.parse_args()

    if args.action == 'hide_image':
        image_steganography.hide_image(args.image_to_image, args.host_image, args.output)
